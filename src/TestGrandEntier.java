...
public class TestGrandEntier {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(tro.toString());
		System.out
		...
		System.out.println("test le multiply et du multiplyFast");
		...
		GrandEntier r12= r11.multiplyFast(r11);
		System.out.println(r10.toString());
		System.out.println(r12.toString());

		System.out
				.println("Resultat attendu : 11 x 16^7 + 13 x 16^6 + 2 x 16^5 + 11 x 16^4 + 8 x 16^3 + 1 x 16^2 + 0 x 16^1 + 0 x 16^0");
